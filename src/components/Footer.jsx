  ...
  return (
    <div className='footer-container'>
      <section className='footer-subscription'>
        ...
        Meram Belediyesi'nin sunduğu güncel videoları ve şehrimizde gerçekleşen olumlu gelişmelerden haberdar olmak için takipte kalmayı unutmayın.
        </p>
        <p className='footer-subscription-text'>
          Önceden haberdar olmak için kayıt olunuz.
        </p>
